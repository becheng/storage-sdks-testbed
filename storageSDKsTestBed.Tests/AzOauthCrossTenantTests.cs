...
public class AzOauthCrossTenantTests : SDKsTestsBase
{
    ...
    {        
        ...
        blobContainerUri = string.Format(_configuration["AzOauthCrossTenantTest:blobContainerUri"], storageAcctName, containerName);

        crossTenantTokenCredential = new ClientSecretCredential(
            _configuration["AzOauthCrossTenantTest:crossTenantId"], 
            _configuration["AzOauthCrossTenantTest:mtClientId"], 
            _configuration["AzOauthCrossTenantTest:mtClientSecret"]);
    }
